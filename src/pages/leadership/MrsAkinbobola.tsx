    ...
    <section className="relative min-h-[90vh] flex items-stretch bg-foreground overflow-hidden">
      ...
      <div className="container relative z-10 flex flex-col lg:flex-row items-stretch w-full py-20 lg:py-0 gap-0">
        ...
        <div className="flex flex-col justify-center flex-1 lg:pr-16 xl:pr-24 py-16 lg:py-24">
          ...
          >
            CEO &amp; Co-Founder, Beaconhill Smile Group
          </motion.p>
          ...
          >
            Business leader driving execution across the Group's operations,
            development portfolio, and commercial strategy.
          </motion.p>
        ...
        <div className="hidden lg:block relative w-[42%] xl:w-[45%] flex-shrink-0 -mr-8">
          ...
          <motion.img
            src="/images/mrs-akinbobola.webp"
            alt="Mrs. Ibitayo Akinbobola"
          ...
          <div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
                Mrs. Ibitayo Akinbobola is a healthcare entrepreneur and
                business leader responsible for driving execution across the
                Group's operations and development portfolio. As CEO, she leads
                the translation of strategy into results, overseeing operations,
                product development, sales, and market positioning, with a focus
                on efficiency, scalability, and commercial viability. She holds
                a BSc in Biomedical Science from the University of Staffordshire
                and an MSc in Pharmaceutical Science from the University of
                Greenwich. She is the Co-Founder of Beaconhill Smile Group.
              </p>
            </motion.div>
          </div>
